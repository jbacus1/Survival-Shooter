...
public class ZomBearMovement : MonoBehaviour
{
    Transform player; // Reference to the player's position
    PlayerHealth playerHealth; // Reference to the player's health
    ZomBearHealth enemyHealth; // Reference to this enemy's health
    ...
    void Awake()
    {
        ...
        enemyHealth = GetComponent<ZomBearHealth>(); // Get this enemy's health component
