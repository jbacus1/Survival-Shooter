...
public class ZomBunnyAttack : MonoBehaviour
{
    // Variables
    ...
    ZomBunnyHealth enemyHealth; // ZomBunny's health component
    GameObject enemyManager; // Reference to the enemy manager
    ZomBunnyManager EMS; // ZomBunny Manager script
    ...
    void Awake()
    {
        ...
        enemyHealth = GetComponent<ZomBunnyHealth>();
        anim = GetComponent<Animator>();
        enemyManager = GameObject.FindGameObjectWithTag("EnemyManager");
        EMS = enemyManager.GetComponent<ZomBunnyManager>();
